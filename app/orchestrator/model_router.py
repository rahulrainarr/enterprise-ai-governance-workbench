...
TASK_TYPES = {"document_qa", "executive_summary", "risk_assessment", "governance_mapping", "technical_architecture", "proposal_drafting", "assessment_analysis", "code_analysis"}
...
def route_model(task_type: str, *, privacy_sensitive: bool = True, external_api_enabled: bool = False, context_length: int = 0, speed_required: bool = False, cost_sensitive: bool = True) -> RoutingDecision:
    ...
    if privacy_level == "high":
        return RoutingDecision(task, "qwen2.5:7b", "local", "High privacy task; local preferred and cloud disabled by default.", "0", privacy_level, "human_review" if external_api_enabled else "extractive")
