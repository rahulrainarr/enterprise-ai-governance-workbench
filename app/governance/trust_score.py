...
def calculate_trust_score(*, evidence_coverage: float, citation_quality: float, hallucination_risk: float, sensitive_exposure_risk: float, prompt_injection_risk: float, policy_conflict_risk: float, answer_completeness: float, retrieval_quality: float) -> TrustScoreResult:
    factors = {
    ...
    weights = {"evidence_coverage": 0.2, "citation_quality": 0.18, "hallucination_control": 0.16, "sensitive_information_control": 0.12, "prompt_injection_control": 0.1, "policy_conflict_control": 0.1, "answer_completeness": 0.07, "retrieval_quality": 0.07}
